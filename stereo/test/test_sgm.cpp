...
//                int sgmDisparityOrig2 = static_cast<u_char>(disparity.at<cv::Vec3b>(j, i)[2]);
    ...
    else
    {
        for (int s = 0; s < 22; s++)
        {
            ...
            std::string left_img_path_orig = "/home/jiatianwu/dso/" + sequence.str() + "/image_0";
            std::string right_img_path_orig = "/home/jiatianwu/dso/" + sequence.str() + "/image_1";
            std::string output_colored_disparitymap_orig = "/home/jiatianwu/dso/" + sequence.str() + "/disparity";
